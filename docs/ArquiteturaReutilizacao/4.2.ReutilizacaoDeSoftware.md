...
- [MILENE, Profa. Arquitetura e Desenho de Software – Aula: Reutilização e Framework. Universidade de Brasília – FGA.](https://aprender3.unb.br/pluginfile.php/3075199/mod_page/content/1/Arquitetura%20e%20Desenho%20de%20Software%20-%20Aula%20Reutiliza%C3%A7%C3%A3o%20%20Framework%20-%20Profa.%20Milene.pdf)  
- [npm – Criando e Gerenciando Pacotes Node.js (Documentação Oficial)](https://docs.npmjs.com/creating-node-js-modules)  
- [Vite – Guia de Build e Configuração (Documentação Oficial)](https://vite.dev/guide/buildbu)  
